class SobreIFSP extends React.Component {

  constructor() {
    super();
    this.state = {instituto_federal: "Instituto Federal de Educação, Ciência e Tecnologia de São Paulo", 
                  endereco_instituto: "Rua Pedro Vicente, 625 - Canindé - São Paulo - SP - Brasil - Cep: 01109-010"};
  }

  render() {   

    return <div>
    <p>O <strong>{this.state.instituto_federal}</strong> – é uma autarquia federal de ensino.</p>
    ...
    <p>Localizado em <strong>{this.state.endereco_instituto}</strong></p>
...
ReactDOM.render(<SobreIFSP />, document.getElementById('sobre'));
